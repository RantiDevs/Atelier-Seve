...
export function ReviewCTA() {
  ...
  return (
    <section ref={containerRef} className="w-full bg-foreground py-32 px-6 md:px-12 flex flex-col items-center justify-center text-center">
      <h2 className="font-serif text-3xl md:text-5xl italic text-background mb-6">
        Ti è piaciuta la tua esperienza con noi?
      </h2>
      <p className="font-sans text-lg text-muted-foreground max-w-2xl mb-12">
        La tua opinione ci aiuta a crescere e ad aiutare altre donne a sentirsi belle.
      </p>
